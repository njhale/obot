...
func (c *Client) UpdateMemory(ctx context.Context, assistantID, projectID, memoryIndex string, content string) (*types.Memory, error) {
	url := fmt.Sprintf("/assistants/%s/projects/%s/memories/%s", assistantID, projectID, memoryIndex)
...
func (c *Client) DeleteMemory(ctx context.Context, assistantID, projectID, memoryIndex string) (*types.Memory, error) {
	url := fmt.Sprintf("/assistants/%s/projects/%s/memories/%s", assistantID, projectID, memoryIndex)
