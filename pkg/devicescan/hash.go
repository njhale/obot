...
//
// Matches runlayer's compute_config_hash: keys are sorted (Go's json.Marshal
// orders map[string]any keys alphabetically), args order is preserved,
// empty command/url collapse to JSON null, empty args list collapses to [].
