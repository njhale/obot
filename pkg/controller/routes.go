...
func (c *Controller) setupRoutes() {
	...
	root.Type(&v1.MCPServerCatalogEntry{}).HandlerFunc(mcpServerCatalogEntryHandler.MigrateCompositeCatalogStorage)
	root.Type(&v1.MCPServerCatalogEntry{}).HandlerFunc(mcpServerCatalogEntryHandler.ClearCompositeCatalogNeedsUpdate)
